  ...
  en: {
    sidebar: {
      ...
      nav: {
        ...
        recurring: { label: 'Recurring',    description: 'Auto monthly transactions' },
        goals:     { label: 'Goals',        description: 'Financial goals & savings' },
        import:    { label: 'Import',       description: 'Import bank statement CSV' },
      },
  ...
  pt: {
    sidebar: {
      ...
      nav: {
        ...
        recurring: { label: 'Recorrentes',  description: 'Transações mensais automáticas' },
        goals:     { label: 'Metas',        description: 'Metas financeiras e poupança' },
        import:    { label: 'Importar',     description: 'Importar extrato do banco CSV' },
      },
